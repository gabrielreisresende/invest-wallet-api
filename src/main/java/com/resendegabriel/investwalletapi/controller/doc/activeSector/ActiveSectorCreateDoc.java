...
@Operation(
        summary = "Create a new active sector",
        description = "Endpoint for an admin user create a new active sector")
@SecurityRequirement(name = "Bearer Authentication")
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "201",
                description = "Active sector created successfully",
                content = @Content(
...
public @interface ActiveSectorCreateDoc {
}
