...
@Operation(
        ...
        description = "Endpoint to get all active sectors.")
@SecurityRequirement(name = "Bearer Authentication")
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "200",
                description = "Active sectors returned successfully",
                content = @Content(
                        mediaType = "application/json",
                        array = @ArraySchema(schema = @Schema(implementation = ActiveSectorResponseDTO.class)))),
        @ApiResponse(
                responseCode = "403",
...
public @interface ActiveSectorGetAllDoc {
}
