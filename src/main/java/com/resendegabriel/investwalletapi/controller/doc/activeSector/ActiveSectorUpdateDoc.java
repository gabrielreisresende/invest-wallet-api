...
@Operation(
        summary = "Update an active sector",
        description = "Endpoint to update an active sector info.")
@SecurityRequirement(name = "Bearer Authentication")
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "200",
                description = "Active sector updated successfully",
                content = @Content(
...
public @interface ActiveSectorUpdateDoc {
}
