...
@Operation(
        summary = "Update an active type",
        description = "Endpoint to update an active type info.")
@SecurityRequirement(name = "Bearer Authentication")
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "200",
                description = "Active type updated successfully",
                content = @Content(
...
public @interface ActiveTypeUpdateDoc {
}
