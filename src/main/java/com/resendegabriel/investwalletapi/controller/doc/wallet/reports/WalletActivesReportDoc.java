...
@Operation(
        summary = "Get a wallet actives report",
        description = "Return a wallet actives report with details of money percentage of each active and with wallet total value.")
...
@ApiResponses(value = {
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        schema = @Schema(implementation = WalletActivesReportDTO.class))),
        @ApiResponse(
                responseCode = "401",
...
public @interface WalletActivesReportDoc {
}
